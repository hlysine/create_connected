...
public class SequencedPulseGeneratorScenes {
    public static void pulseGenerator(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.overlay.showControls(new InputWindowElement(util.vector.centerOf(pulseGenerator), Pointing.DOWN).rightClick(), 40);
        scene.idle(7);
        scene.overlay.showSelectionWithText(util.select.position(pulseGenerator), 60)
