...
public class SixWayGearboxInstance extends KineticBlockEntityInstance<SixWayGearboxBlockEntity> {

    protected final EnumMap<Direction, RotatingData> keys;
    protected Direction sourceFacing;

    public SixWayGearboxInstance(MaterialManager materialManager, SixWayGearboxBlockEntity blockEntity) {
