...
public class CrankWheelItem extends BlockItem {
    ...
    private static class SmallCogHelper extends DiagonalCogHelper {
        ...
        public Predicate<ItemStack> getItemPredicate() {
            return ((Predicate<ItemStack>) ICogWheel::isSmallCogItem).and(CrankWheelItem::isCrankWheelItem);
        }
    ...
    private static class LargeCogHelper extends DiagonalCogHelper {
        ...
        @Override
        public Predicate<ItemStack> getItemPredicate() {
            return ((Predicate<ItemStack>) ICogWheel::isLargeCogItem).and(CrankWheelItem::isCrankWheelItem);
        }
